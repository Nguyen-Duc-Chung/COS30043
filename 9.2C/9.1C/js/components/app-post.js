      ...
      <v-card class="mx-auto" max-width="90%">
        <v-card-text>
          <v-form>
            ...
            <v-text-field label="Description" v-model="desc1" />
    ...
    postData: function (code, desc, cp, type) {
      ...
      fetch(postSQLApiURL, requestOptions)
        ...
        .then(data => {
          ...
          self.statusVal = "Data Inserted Successfully."
          self.statusText = "Data Inserted Successfully."
          self.headers = "Data Inserted Successfully."
        })
        .catch(error => {
